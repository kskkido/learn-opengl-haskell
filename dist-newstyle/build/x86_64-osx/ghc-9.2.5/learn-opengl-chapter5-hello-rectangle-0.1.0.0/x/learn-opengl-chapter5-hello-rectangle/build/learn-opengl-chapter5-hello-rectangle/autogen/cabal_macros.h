...
/* package learn-opengl-chapter5-hello-rectangle-0.1.0.0 */
#ifndef VERSION_learn_opengl_chapter5_hello_rectangle
#define VERSION_learn_opengl_chapter5_hello_rectangle "0.1.0.0"
#endif /* VERSION_learn_opengl_chapter5_hello_rectangle */
#ifndef MIN_VERSION_learn_opengl_chapter5_hello_rectangle
#define MIN_VERSION_learn_opengl_chapter5_hello_rectangle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_learn_opengl_chapter5_hello_rectangle */
...
#define CURRENT_COMPONENT_ID "learn-opengl-chapter5-hello-rectangle-0.1.0.0-inplace-learn-opengl-chapter5-hello-rectangle"
